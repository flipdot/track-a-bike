...
if __name__ == '__main__':
    ...
    result = list(session.run("MATCH (a)-[r:BIKE_MOVED]->(b) RETURN a.name as name, r.timestamp_start as timestamp;"))
    ...
    result = list(session.run("MATCH (a)-[r:BIKE_MOVED]->(b) RETURN b.name as name, r.timestamp_end as timestamp;"))
