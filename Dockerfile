...
RUN apt-get install -y wget bzip2 ca-certificates \
    ...
    libgd3 libgdk-pixbuf2.0-0 libgtk2.0-0 libgts-0.7-5 \
    liblasi-dev libltdl7 libpango-1.0-0 libpangocairo-1.0-0 \
    libpangoft2-1.0-0 librsvg2-2 curl grep sed dpkg \
    python3-pyqt4 tzdata libann0 fontconfig
